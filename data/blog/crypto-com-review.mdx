...
In January 2022, attackers bypassed two-factor authentication on 483 accounts and withdrew about $34 million in bitcoin, ether, and other currencies. Crypto.com fully reimbursed or blocked all affected withdrawals, rebuilt its 2FA infrastructure, and launched an account-protection program covering qualified users up to $250,000. It also publishes **proof of reserves** — cryptographic evidence, using a Merkle tree, that customer balances are backed by real assets — though its headline third-party verification by auditor Mazars dates to December 2022, and proof of reserves is narrower than a full audit.
